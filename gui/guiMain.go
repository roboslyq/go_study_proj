...
func main() {
	mw := &MainWindow{model: NewEnvModel()}

	if _, err := (dec.MainWindow{
		AssignTo: &mw.MainWindow,
		Title:    "发版工具V1.0.0",
		MinSize:  dec.Size{240, 320},
		Size:     dec.Size{300, 400},
...
func (mw *MainWindow) lb_CurrentIndexChanged() {
...
func (mw *MainWindow) lb_ItemActivated() {
